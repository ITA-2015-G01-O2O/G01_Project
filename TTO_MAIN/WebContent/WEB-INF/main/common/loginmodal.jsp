        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="bttons">
                        <a class="btn btn-primary btn-block" type="submit" onclick="consumerlogin()">Login</a> <a class="btn btn-success btn-block" href="/account/consumer/register.view">Register</a>
                    </div>
                </div>
            </div>
        </div>
