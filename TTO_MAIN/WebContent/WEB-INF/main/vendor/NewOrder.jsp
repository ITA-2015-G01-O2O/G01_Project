		...
		<div class="container container-main">
						...
						<div class="col-xs-3">
							<div calss="operate">
								<ul class="nav nav-pills nav-stacked">
									...
									<li role="presentation"><a href="storeInfo.html"><i class="glyphicon glyphicon-triangle-right"></i>&emsp;Store Information</a></li>
						...
						<div class="col-xs-9 main-wrapper">
							<div id="flowLayot" class="col-xs-12">
								...
								<div class="col-xs-12" style="height: 180px;margin-bottom: 70px;">
									<div class="col-xs-4" style="height: 160px;margin-left: 0px;padding: 0px;">
										<div>
											<table class="table" style="border: 1px solid #ddd;margin-bottom: 0px;">
												...
												<tr>
													<td width="100px">鸡肉卷</td>
													<td>1</td>
													<td>20</td>
												</tr>
												<tr>
													<td width="100px">鸡腿</td>
													<td>2</td>
													<td>10</td>
												</tr>
												<tr>
													<td width="100px">薯条</td>
													<td>1</td>
													<td>18</td>
												</tr>
											</table>
										...
										<div style="padding: 0px;border: 1px solid #ddd;text-align: center;">
											<label>总价格</label>
											<label id="priaceLabel">27</label>
										</div>
									</div>

									<div class="col-xs-8" style="height:176px;border:1px solid #ddd;text-align: left;">
										<label>订单号：</label>
										<label id="orderNum">130000000000000</label>
										<br/>
										<label>下单日期：</label>
										<label id="orderDate">2015-08-23 17:52:23</label>
										<br/>
										<label>订单状态：</label>
										<label id="orderDate">商家未确认</label>
										<br/>
										<label>联系人：</label>
										<label id="orderState">ChenAce</label>
										<br/>
										<label>电话：</label>
										<label id="orderTel">13000000000</label>
										<br/>
										<label>地址：</label>
										<label id="orderTel">南方软件园B5 1-4单元 5楼</label>
										<br/>
									</div>
			...
			<div class="col-xs-12">
				<nav class="text-center">
					...
					<span><a href="#">关注 </a> </span> | <span><a href="#"> 客服热线：4000000</a></span>
