...
<body>
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img data-src="holder.js/900x500/auto/#777:#555/text:First slide"
							alt="First slide [900x500]" src="../images/temp.jpg"
		...
		<div class="row">
			<div class="col-xs-12 main-wrapper">
				...
				<div class="nav sorter">
					<div class="btn-group navbar-form navbar-left" role="group">
						<button type="button" class="btn btn-default">
							销量&nbsp;<span class="glyphicon glyphicon-sort-by-attributes"
				...
				<div class="row venders">
					<div class="col-xs-3">
						<a href="../../nick/index.html" class="thumbnail"> <img
							src="../images/rice.png">
						</a>
						<h4>汉堡店</h4>
						<div class="row">
							<div class="col-xs-6">评分：4分</div>
							<div class="col-xs-6">销量:888单</div>
						</div>
						<div class="row">

							<div class="col-xs-6">30元 起送</div>
							<div class="col-xs-6">免外卖费</div>
						</div>
						<div class="row">
	...
	<div id="footer">
		<a href="#">关注微信</a> <a>|</a> <a href="#">关注微博</a> <a>|</a> <a
			href="../../../Vendor/register1.html">我要开店</a> <a>|</a> <a><span>客服电话400-xxx-xxx</span>
		</a>
	</div>
</body>
<script src="//cdn.bootcss.com/jquery/1.11.3/jquery.min.js"></script>
<script src="//cdn.bootcss.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
<script src="../consumer/js/search.js"></script>
<script src="../consumer/js/basic.js"></script>
</html>