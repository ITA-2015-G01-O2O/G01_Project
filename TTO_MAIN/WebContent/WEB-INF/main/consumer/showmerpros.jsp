...
<body>
						...
						<div class="col-xs-9">
							...
							<div class="row">
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation"><a href="#comment" aria-controls="comment" role="tab" data-toggle="tab">Conmment</a></li>
								</ul>
		...
		<script src="js/consumer/consumer.js"></script>
	</body>
