<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
        ...
        <body>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel " class="tab-pane active" id="meals">
                                            ...
                                            <div class="col-xs-12 secondTitle" id="showAllpros">
                                                <a type="button" class="btn btn-default btn-sm" onclick="clickproLabelgetAll()">All</a>
                                                <a type="button" id="labelBtn" class="btn btn-default btn-sm" style="display: none" onclick="clickproLabel(this)">Sort</a>
                                            </div>
											...
											月售<span>50</span>份
                                                ...
                                                <button type="button" onclick="addMeals(this)" class="btn btn-default pull-right">
            ...
            <div class="modal fade" id="successaddCollect" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
